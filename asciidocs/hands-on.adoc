...
// :last-update-label: Creative Commons CC BY-NC-ND (Attribution-NonCommercial-ShareAlike-NoDerivatives) Copyright 2020, https://www.seqera.io/[Seqera Labs]. All rights reserved. Not for redistribution.
// :last-update-label!: Hello world
:icons: font
:toclevels: 3
:imagesdir: ./assets/
